...
Antes de fechar a revisão da Parte 2, varra TODOS os marcadores ✦: cada um bate com a voz do bloco que encabeça? CADA troca de narrador — inclusive todo retorno à heroína depois de um bloco do parceiro — tem o seu ✦ NOME (nenhum trecho órfão sem cabeçalho)? Nenhum bloco troca de narrador no meio sem marcador? A cena íntima ficou num POV só (a heroína)?`;
