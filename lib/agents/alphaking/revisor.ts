...
/**
 * Template do agente Revisor (Romance Alpha King / Werewolf).
 *
 * Editor literário rigoroso de romance werewolf. Aplica 4 graus de
...
export const revisorAgentTemplate: Omit<Agent, "id"> = {
  label: "Revisor",
  description:
    "Editor literário rigoroso de Alpha King / Werewolf — revisa o roteiro completo classificando erros em 4 graus (🟢 / 🟡 / 🔴 / 💀), numerando sequencialmente, com análise de leitora real, hater e nota final 0-10",
  model: MODELS.opus,
  thinking: "disabled",
  effort: "low",
  systemPrompt:
