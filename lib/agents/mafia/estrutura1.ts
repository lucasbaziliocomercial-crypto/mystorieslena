...
export const estrutura1Agent: Agent = {
  ...
  description:
    "Monta a estrutura completa da Parte 1 de Máfia (12.500 palavras, 5-6 capítulos) — mapa, capítulos com ritmo graduado, cena de entrega, dúvida sutil no final",
  model: MODELS.opus,
  thinking: "adaptive",
  effort: "medium",
