...
Deslize de narração para 3ª pessoa — 💀 GRAVÍSSIMO. A história é em 1ª pessoa: a FMC narra as DUAS Partes e o MMC narra só os trechos ✦ dele (Parte 2), sempre em 1ª pessoa. Qualquer trecho em que a narradora se refere a SI MESMA pelo próprio nome ou em 3ª pessoa dentro do próprio POV ("Marceline ouviu o gelo bater no copo", "o coração dela disparou", "ela sentiu medo") quebra o padrão narrativo. A 3ª pessoa só vale para descrever OUTROS personagens. Apontar o trecho, dar o conserto em 1ª pessoa ("Ouvi o gelo bater no copo") e classificar 💀. NÃO confundir com a ONISCIÊNCIA DA NARRADORA (item 13) — aqui o problema é a PESSOA gramatical (3ª em vez de 1ª), não o que ela sabe.
